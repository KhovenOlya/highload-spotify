...
|-------------------------|---------------------|------------|
| Европа                 | \(10.83M \times 0.34 = 3.68M\) | \( \frac{3.68M}{4} = 920K \) |
| Северная Америка + Канада | \(10.83M \times 0.24 = 2.60M\) | \( \frac{2.60M}{3} = 867K \) |
| Латинская Америка      | \(10.83M \times 0.22 = 2.38M\) | \( \frac{2.38M}{2} = 1.19M \) |
| Остальное             | \(10.83M \times 0.20 = 2.17M\) | \( \frac{2.17M}{2} = 1.08M \) |
...
| Регион                  | Общий RPS по региону | RPS на 1 ДЦ |
|-------------------------|---------------------|------------|
| Европа                 | \(728 \times 0.34 = 248\) | \( \frac{248}{4} = 62 \) |
| Северная Америка + Канада | \(728 \times 0.24 = 175\) | \( \frac{175}{3} = 58 \) |
| Латинская Америка      | \(728 \times 0.22 = 160\) | \( \frac{160}{2} = 80 \) |
| Остальное             | \(728 \times 0.20 = 146\) | \( \frac{146}{2} = 73 \) |
...
| Регион                  | Общий RPS по региону | RPS на 1 ДЦ |
|-------------------------|---------------------|------------|
| Европа                 | \(2407 \times 0.34 = 818\) | \( \frac{818}{4} = 205 \) |
| Северная Америка + Канада | \(2407 \times 0.24 = 577\) | \( \frac{577}{3} = 192 \) |
| Латинская Америка      | \(2407 \times 0.22 = 529\) | \( \frac{529}{2} = 265 \) |
| Остальное             | \(2407 \times 0.20 = 481\) | \( \frac{481}{2} = 241 \) |
...
| Регион                  | Общий RPS по региону | RPS на 1 ДЦ |
|-------------------------|---------------------|------------|
| Европа                 | \(1204 \times 0.34 = 409\) | \( \frac{409}{4} = 102 \) |
| Северная Америка + Канада | \(1204 \times 0.24 = 289\) | \( \frac{289}{3} = 96 \) |
| Латинская Америка      | \(1204 \times 0.22 = 265\) | \( \frac{265}{2} = 133 \) |
| Остальное             | \(1204 \times 0.20 = 241\) | \( \frac{241}{2} = 121 \) |
...
| Регион                  | Общий RPS по региону | RPS на 1 ДЦ |
|-------------------------|---------------------|------------|
| Европа                 | \(24074 \times 0.34 = 8185\) | \( \frac{8185}{4} = 2046 \) |
| Северная Америка + Канада | \(24074 \times 0.24 = 5778\) | \( \frac{5778}{3} = 1926 \) |
| Латинская Америка      | \(24074 \times 0.22 = 5296\) | \( \frac{5296}{2} = 2648 \) |
| Остальное             | \(24074 \times 0.20 = 4815\) | \( \frac{4815}{2} = 2408 \) |

---

## Итог  

Теперь значения RPS рассчитаны корректно, учитывая, что нагрузка распределяется **пропорционально** долям регионов.
