...
Размер треков зависит от качества. Допустим среднее время трека - 3 минуты. Трек хранится в таких вариантах качества: низкое весит около 540 KБ, среднее - 2.16 MБ, высокое - 	3.6 MБ, очень высокое - 	7.2 MБ. 
...
|------------------------|--------------------------|----------------------|----------------------|------------------|
| Прослушивание треков  | **17.85 ПБ**               | **1.65 Тбит/с**       | **3.31 Тбит/с**       | **10.83M**       |
| Поиск треков         | **15.7 ТБ**                | **1.42 Гбит/с**      | **2.84 Гбит/с**       | **727**          |
| Добавление в избранное | **0.357 ТБ**              | **33.85 Мбит/с**     | **67.71 Мбит/с**      | **2407**         |
...
1. **Прослушивание треков**:  
   - `104 млн пользователей × 150 минут × 1,2 МБ / минута = 17.85 ПБ / день`  
   - `17.85 ПБ / (24 × 3600) ≈ 1.65 Тбит/с`  
   - Пик: `1.65 × 2 = 3.31 Тбит/с` 
...
|ClickHouse|Использование ZooKeeper для репликации данных и управления состоянием реплик в кластере.|
