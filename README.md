...
|-------------|--------------------|
|Backend      |- Средства Kubernets. Если нода упала, кубер запустит поды на других|
|             |- Round-robin балансировка между подами  |
|БД           |- Создание бэкапов|
|             |- Шардирование данных на основе id|
|Cartridge Tarantool|- Управление распределенными кластерами|
|                  |- Горячие реплики, для того чтобы данные могли не только идти на чтение, но и на запись|
|                  |  - Может взять на себя мгновенно роль мастера|
