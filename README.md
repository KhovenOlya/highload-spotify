...
| Действие пользователя  | Общий RPS  | RPS на датацентр |
|------------------------|-----------|-----------------------------|
| Прослушивание треков  | 10.83M    | 984K                        |
| Поиск треков          | 728       | 66                           |
| Добавление в избранное | 2407      | 219                          |
| Создание плейлистов   | 1204      | 110                          |
| История прослушиваний | 24074     | 2189                         |

\*RPSдц = (RPSобщ)/11

*Деление на количество датацентров означает, что нагрузка на датацентры будет равномерная.*
